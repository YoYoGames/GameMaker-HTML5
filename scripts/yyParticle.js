...
function ParticleType_Colour_RGB(_ind, _rmin, _rmax, _gmin, _gmax, _bmin, _bmax)
{
	...
	pPar.colpar[0] = ConvertGMColour(yyGetInt32(_rmin));
	pPar.colpar[1] = ConvertGMColour(yyGetInt32(_rmax));
	pPar.colpar[2] = ConvertGMColour(yyGetInt32(_gmin));
	pPar.colpar[3] = ConvertGMColour(yyGetInt32(_gmax));
	pPar.colpar[4] = ConvertGMColour(yyGetInt32(_bmin));
	pPar.colpar[5] = ConvertGMColour(yyGetInt32(_bmax));
}
